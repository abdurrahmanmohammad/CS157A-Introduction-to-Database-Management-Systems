<%@ page import="administrators.Administrators,members.Members,users.Users,java.util.ArrayList,java.util.HashMap" language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<table class="content-table">
		...
		<tr>
			...
			<td>
				<form action=<%="updateMember.jsp?adminID="+adminID%> method="post">
