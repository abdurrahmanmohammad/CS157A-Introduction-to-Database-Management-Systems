<%@ page import="administrators.Administrators,courses.Courses,java.util.ArrayList,java.util.HashMap"
...
<body>
	...
	<table class="content-table">
		...
		<tr>
			...
			<td>
				<form action=<%="updateCourse.jsp?adminID="+adminID%> method="post">
