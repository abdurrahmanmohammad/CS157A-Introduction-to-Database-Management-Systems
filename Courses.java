...
public class Courses {
    ...
    private static String connection = "jdbc:mysql://localhost:3306/demo?serverTimezone=EST5EDT";
    private static String user = "root"; // 'root' is default username
    private static String password = "r"; // 'rootroot' is default password
    ...
    public static String update(String department, String number, String name) {
        //return "In update";
            ...
            // Connect to DB: Return error message if connection failed
            String error = mysqlConnect();
            if (error != "Successfully connected to database.") return "Print this";
            // Attempt to insert
            try {
                // using PreparedStatement
