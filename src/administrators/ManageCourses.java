...
public class ManageCourses extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (option.equals("3")) { // Option 3
			...
			if (department.isEmpty() || number.isEmpty() | title.isEmpty() | units.isEmpty() | cost.isEmpty()) { // If a
																													// field
																													// is
																													// empty
			...
			Courses.insert(department, number, title, units, cost); // Create and add course to DB
